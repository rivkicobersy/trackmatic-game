...
import { Trophy, Truck, RotateCcw, Home } from 'lucide-react';
      ...
      <div className="max-w-md w-full bg-blue-900 rounded-lg shadow-xl overflow-hidden">
        <div className="bg-blue-800 p-6 text-center">
          ...
          <div className="flex justify-center">
            <Truck className="text-amber-500 mr-2" size={24} />
        ...
        <div className="p-6 space-y-6">
          <div className="text-center">
            <div className="inline-block bg-blue-800 rounded-lg p-4">
          ...
          <div className="bg-blue-950 rounded-lg p-4 text-center">
            {score > 500 ? (
              <>
              ...
              <>
                <p className="text-lg font-bold text-blue-400">Good Start!</p>
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            <button
              ...
              className="flex-1 bg-green-600 hover:bg-green-700 text-white font-bold py-3 px-4 rounded-md transition duration-300 flex items-center justify-center"
            >
            ...
            <button
              ...
              className="flex-1 bg-blue-600 hover:bg-blue-700 text-white font-bold py-3 px-4 rounded-md transition duration-300 flex items-center justify-center"
            >
